...
export function prepareConfig({
    ...
    return defineConfig(
        ...
        },
        {
            ...
            rules: mergeRules(...jsonc.configs['recommended-with-json'], json.configs.recommended)
        },
        {
            ...
            rules: mergeRules(...jsonc.configs['recommended-with-jsonc'], json.configs.recommended)
        },
        {
            ...
            rules: mergeRules(...jsonc.configs['recommended-with-json5'], json.configs.recommended)
        },
        {
