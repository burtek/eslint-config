...
[![Socket Badge](https://badge.socket.dev/npm/package/@dtrw/eslint-config/7.0.0)](https://badge.socket.dev/npm/package/@dtrw/eslint-config/7.0.0)
...
```bash
yarn add -D @dtrw/eslint-config@~7.0.0 eslint
# or
pnpm add -D @dtrw/eslint-config@~7.0.0 eslint
# or
npm i -D @dtrw/eslint-config@~7.0.0 eslint
```
